...
module config_string_and_timer(
	...
	//
	assign mem[`DataMemNum - 5] = {31'h0, software_int};
	assign mem[`DataMemNum - 4] = mtime[31:0];
	assign mem[`DataMemNum - 3] = mtime[63:32];
	assign mem[`DataMemNum - 2] = mtimecmp[31:0];
	assign mem[`DataMemNum - 1] = mtimecmp[63:32];
